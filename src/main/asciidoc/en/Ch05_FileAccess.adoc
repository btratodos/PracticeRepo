...
|(6)
|Throw an exception when the fetched number of bytes exceeds the maximum length.

|(7)
|Format the value by trimming or padding it according to the fetched number of bytes. +
