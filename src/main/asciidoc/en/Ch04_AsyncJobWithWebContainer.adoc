...
|(1)
|Delete spring-mvc.xml since it is not required because spring-mvc-rest.xml is created in (2).

|(2)
|Create spring-mvc-rest.xml for RESTful Web Service. Description example where definition is required is shown below.
